    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="row">
        <div className="col-md-6 mb-3">
          ...
          <input
            type="number"
            className={`form-control ${errors.quotaLimit ? "is-invalid" : ""}`}
            id="quotaLimit"
            name="quotaLimit"
        ...
        <div className="col-md-6 mb-3">
          ...
          <input
            type="text"
            className={`form-control ${errors.water ? "is-invalid" : ""}`}
            id="water"
            name="water"
      ...
      {!isEditMode && (
        <div className="card mb-3">
          <div className="card-header">
            <h5 className="mb-0">Assigned Ranger Information</h5>
          </div>
          <div className="card-body">
            <div className="row">
              <div className="col-md-6 mb-3">
                ...
                <input
                  type="text"
                  className={`form-control ${errors["ranger.name"] ? "is-invalid" : ""}`}
                  id="ranger.name"
                  name="ranger.name"
              ...
              <div className="col-md-6 mb-3">
                ...
                />
                {errors["ranger.phone_number"] && (
                  <div className="invalid-feedback">{errors["ranger.phone_number"]}</div>
                )}
              </div>
            </div>
