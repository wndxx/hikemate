                        ...
                        <div className="card-body">
                          <div className="row g-3">
                            ...
                            <div className="col-md-4">
                              ...
                              <select className="form-select" id="status" name="status" value={formData.status} onChange={handleInputChange} required>
                            ...
                            <div className="col-md-4">
                              ...
                              <input type="number" className="form-control" id="quotaLimit" name="quotaLimit" value={formData.quotaLimit} onChange={handleInputChange} required />
                            </div>
                            <div className="col-md-6">
                              <div className="form-check form-switch mt-4">
                                <input className="form-check-input" type="checkbox" id="isOpen" name="isOpen" checked={formData.isOpen} onChange={handleInputChange} />
                            ...
                            <div className="col-md-6">
                              <div className="form-check form-switch mt-4">
                                <input className="form-check-input" type="checkbox" id="toilet" name="toilet" checked={formData.toilet} onChange={handleInputChange} />
                            ...
                            <div className="col-12">
                              ...
                              <input type="text" className="form-control" id="water" name="water" value={formData.water} onChange={handleInputChange} placeholder="e.g., Available at basecamp and pos 2" required />
                            </div>
                            <div className="col-12">
                              <label htmlFor="description" className="form-label">
                                Description <span className="text-danger">*</span>
                              </label>
                              <textarea className="form-control" id="description" name="description" rows="4" value={formData.description} onChange={handleInputChange} required></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="card-body">
                          <div className="row g-3">
                            <div className="col-md-6">
                              ...
                              <input type="text" className="form-control" id="ranger_name" name="ranger_name" value={formData.assigned_ranger.name} onChange={handleInputChange} required />
                            </div>
                            <div className="col-md-6">
                              <label htmlFor="ranger_phone_number" className="form-label">
                                Phone Number <span className="text-danger">*</span>
                              </label>
                              <input type="text" className="form-control" id="ranger_phone_number" name="ranger_phone_number" value={formData.assigned_ranger.phone_number} onChange={handleInputChange} required />
                            </div>
                            <div className="col-md-6">
                              <label htmlFor="ranger_email" className="form-label">
                                Email <span className="text-danger">*</span>
                              </label>
                              <input type="email" className="form-control" id="ranger_email" name="ranger_email" value={formData.assigned_ranger.email} onChange={handleInputChange} required />
                            </div>
                            <div className="col-md-6">
                              <label htmlFor="ranger_password" className="form-label">
                                Password <span className="text-danger">*</span>
                              </label>
                              <input type="password" className="form-control" id="ranger_password" name="ranger_password" value={formData.assigned_ranger.password} onChange={handleInputChange} required />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="card mb-4">
                        ...
                        <div className="card-body">
                          <div className="mb-4">
                            ...
                            <input type="file" className="form-control" id="mountainCover" accept="image/*" onChange={handleCoverImageChange} required />
                            {previewCover && (
                              <div className="mt-3">
                                <img src={previewCover || "/placeholder.svg"} alt="Mountain Cover Preview" className="img-thumbnail" style={{ maxHeight: "150px", width: "100%", objectFit: "cover" }} />
                              </div>
                            )}
                          </div>
                          ...
                          <div>
                            ...
                            <input type="file" className="form-control" id="basecampImages" accept="image/*" multiple onChange={handleBasecampImagesChange} />
                            {previewBasecamp.length > 0 && (
                              <div className="mt-3 row g-2">
                                {previewBasecamp.map((preview, index) => (
                                  <div className="col-6" key={index}>
                                    <img src={preview || "/placeholder.svg"} alt={`Basecamp Preview ${index + 1}`} className="img-thumbnail" style={{ height: "80px", width: "100%", objectFit: "cover" }} />
                                  </div>
                                ))}
                              </div>
                            )}
                            ...
                            <div>
                              {routes.map((route) => (
                                <div className="form-check mb-2" key={route.id}>
                                  <input className="form-check-input" type="checkbox" id={`route-${route.id}`} checked={formData.mountainRoutes.some((r) => r.id === route.id)} onChange={(e) => handleRouteChange(e, route.id)} />
